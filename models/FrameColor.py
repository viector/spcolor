...
def warp_color(IA_l, IB_lab, features_B, vggnet, nonlocal_net, feature_noise=0, temperature=0.01):
...
def frame_colorization(
    ...
    with torch.autograd.set_grad_enabled(True):
        nonlocal_BA_lab, similarity_map, features_A_gray = warp_color(
            IA_l, IB_lab, features_B, vggnet, nonlocal_net, feature_noise, temperature=temperature
        )
